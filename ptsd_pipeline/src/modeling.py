...
def run_baseline(device=None) -> None:
    ...
    evaluate(texts_train, y_train, vectorizer, classifier, mlb, model_name="TF-IDF + LR — Train set")
    evaluate(texts_val,   y_val,   vectorizer, classifier, mlb, model_name="TF-IDF + LR — Validation set")
