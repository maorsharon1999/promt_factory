...
def run_stage_1(mock: bool = False) -> None:
    ...
    from src.data_generation import (
        OllamaClient, LLMConfig, LLMProvider, LLMClient,
    ...
    if mock:
    ...
    elif ollama_client.health_check():
        logger.info("Ollama running — using local model (llama3).")
        ...
        logger.warning(
            ...
            "Start Ollama or set OPENROUTER_API_KEY to generate real data."
        )
        llm = MockLLMClient()
